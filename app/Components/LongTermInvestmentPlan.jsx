...
const LongTermInvestmentPlan = () => {
  ...
  const handlePropertyChange = useCallback(
    (year, propertyIndex, field, value) => {
      setProperties((prevProperties) => {
        const newProperties = [...prevProperties];
        ...
        return newProperties.map((yearProperties) =>
          yearProperties.map(calculatePropertyDetails)
        );
      });
    },
    ...
    setProperties((prevProperties) => {
      ...
      if (count > currentCount) {
        ...
        newProperties[year - 1] = [
          ...newProperties[year - 1],
          ...Array(count - currentCount)
            .fill()
            .map(() => ({ ...newProperties[year - 1][0] })),
        ];
  ...
  const handleApplyPrices = useCallback((year, propertyIndex) => {
    const sourceProperty = properties[year - 1][propertyIndex];
    
    setProperties(prevProperties => 
      prevProperties.map(yearProperties => 
        yearProperties.map(property => 
          calculatePropertyDetails({
            ...property,
            propertyPrice: sourceProperty.propertyPrice,
            downPaymentPercentage: sourceProperty.downPaymentPercentage,
            interestRate: sourceProperty.interestRate,
            mortgageTerm: sourceProperty.mortgageTerm,
            monthlyRent: sourceProperty.monthlyRent,
            propertyTaxType: sourceProperty.propertyTaxType,
            propertyTaxRate: sourceProperty.propertyTaxRate,
            propertyTaxAmount: sourceProperty.propertyTaxAmount,
            insuranceType: sourceProperty.insuranceType,
            insuranceRate: sourceProperty.insuranceRate,
            insuranceAmount: sourceProperty.insuranceAmount,
            maintenanceType: sourceProperty.maintenanceType,
            maintenanceRate: sourceProperty.maintenanceRate,
            maintenanceAmount: sourceProperty.maintenanceAmount,
            condoFees: sourceProperty.condoFees,
            vacancyType: sourceProperty.vacancyType,
            vacancyRate: sourceProperty.vacancyRate,
            vacancyAmount: sourceProperty.vacancyAmount,
          })
        )
      )
    );
    ...
    toast({
      ...
      description: "The prices have been applied to all properties across all years.",
    })
  }, [properties, calculatePropertyDetails, toast]);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        {years.map((year) => (
          <Card key={year} className="p-4">
            ...
            <CardContent>
              <div className="mb-4">
                <Label htmlFor={`propertyCount-${year}`}>
                  Number of Properties :{" "}
                  <span className="text-sm">{properties[year - 1].length}</span>
                </Label>
                <Slider
                  ...
                  onValueChange={(value) =>
                    handlePropertyCountChange(year, value[0])
                  }
                />
              </div>
                ...
                {properties[year - 1].map((property, index) => (
                  <Dialog key={index}>
                    ...
                    <DialogContent className="max-w-[800px] max-h-[80vh] overflow-y-auto bg-white text-black">
                      <DialogHeader>
                        <DialogTitle>
                          Property {index + 1} Details - Year {year}
                        </DialogTitle>
                        <Button 
        onClick={() => handleApplyPrices(year, index)} 
        className="absolute top-2 text-sm bg-blue-500 hover:bg-blue-600 right-2"
      >
        Apply this prices to all properties
      </Button>
                      </DialogHeader>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor={`propertyPrice-${year}-${index}`}>
                            Property Price
                          </Label>
                          <Input
                        ...
                        <div>
                          <Label htmlFor={`downPayment-${year}-${index}`}>
                            Down Payment (%)
                          </Label>
                          <Slider
                        ...
                        <div>
                          <Label htmlFor={`interestRate-${year}-${index}`}>
                            Interest Rate (%)
                          </Label>
                          <Slider
                        ...
                        <div>
                          <Label htmlFor={`mortgageTerm-${year}-${index}`}>
                            Mortgage Term (years)
                          </Label>
                          <Slider
                        ...
                        <div>
                          <Label htmlFor={`monthlyRent-${year}-${index}`}>
                            Monthly Rent
                          </Label>
                          <Input
                        ...
                        <div>
                          <Label htmlFor={`propertyTax-${year}-${index}`}>
                            Property Tax
                          </Label>
                          <div className="flex items-center space-x-2">
                            <input
                              ...
                              checked={
                                property.propertyTaxType === "percentage"
                              }
                              onChange={() =>
                                handlePropertyChange(
                                  year,
                            ...
                            />
                            <label
                              htmlFor={`propertyTaxPercentage-${year}-${index}`}
                            >
                              %
                            </label>
                            <input
                            ...
                            />
                            <label
                              htmlFor={`propertyTaxAmount-${year}-${index}`}
                            >
                              $
                            </label>
                          </div>
                        ...
                        <div>
                          <Label htmlFor={`insurance-${year}-${index}`}>
                            Insurance
                          </Label>
                          <div className="flex items-center space-x-2">
                            <input
                            ...
                            />
                            <label
                              htmlFor={`insurancePercentage-${year}-${index}`}
                            >
                              %
                            </label>
                            <input
                            ...
                            />
                            <label htmlFor={`insuranceAmount-${year}-${index}`}>
                              $
                            </label>
                          </div>
                          <Input
                            type="number"
                            value={
                              property.insuranceType === "percentage"
                        ...
                        <div>
                          <Label htmlFor={`maintenance-${year}-${index}`}>
                            Maintenance
                          </Label>
                          <div className="flex items-center space-x-2">
                            <input
                              ...
                              checked={
                                property.maintenanceType === "percentage"
                              }
                              onChange={() =>
                                handlePropertyChange(
                                  year,
                            ...
                            />
                            <label
                              htmlFor={`maintenancePercentage-${year}-${index}`}
                            >
                              %
                            </label>
                            <input
                            ...
                            />
                            <label
                              htmlFor={`maintenanceAmount-${year}-${index}`}
                            >
                              $
                            </label>
                          </div>
                        ...
                        <div>
                          <Label htmlFor={`vacancy-${year}-${index}`}>
                            Vacancy
                          </Label>
                          <div className="flex items-center space-x-2">
                            <input
                            ...
                            />
                            <label
                              htmlFor={`vacancyPercentage-${year}-${index}`}
                            >
                              %
                            </label>
                            <input
                            ...
                            />
                            <label htmlFor={`vacancyAmount-${year}-${index}`}>
                              $
                            </label>
                          </div>
                          <Input
                            type="number"
                            value={
                              property.vacancyType === "percentage"
                                ? property.vacancyRate
                                : property.vacancyAmount
                            }
                            onChange={(e) =>
                              handlePropertyChange(
                                year,
                        ...
                        <div>
                          <Label htmlFor={`condoFees-${year}-${index}`}>
                            Condo Fees
                          </Label>
                          <Input
                          ...
                          <div>
                            ...
                            <p>
                              ...
                              <span className="font-bold">
                                ${property.monthlyMortgage?.toFixed(2)}
                              </span>
                            </p>
                            <p>
                              Total Monthly Costs:{" "}
                              <span className="font-bold">
                                ${property.totalMonthlyCosts?.toFixed(2)}
                              </span>
                            </p>
                            <p>
                              Net Cash Flow:{" "}
                              <span className="font-bold">
                                ${property.netCashFlow?.toFixed(2)}
                              </span>
                            </p>
                          </div>
                          <div>
                            ...
                            <p>
                              Monthly Mortgage:{" "}
                              <span className="font-bold">
                                ${(property.monthlyMortgage * 12).toFixed(0)}
                              </span>
                            </p>
                            <p>
                              Total Monthly Costs:{" "}
                              <span className="font-bold">
                                ${(property.totalMonthlyCosts * 12).toFixed(0)}
                              </span>
                            </p>
                            <p>
                              Net Cash Flow:{" "}
                              <span className="font-bold">
                                ${(property.netCashFlow * 12).toFixed(0)}
                              </span>
                            </p>
                          </div>
                        </div>
  ...
  const calculateCumulativeProfit = useCallback(() => {
    ...
    for (let year = 1; year <= totalYears; year++) {
      ...
      for (let i = 0; i < year; i++) {
        yearlyProfit += properties[i].reduce(
          (sum, property) => sum + property.netCashFlow * 12,
          0
        );
      }
    ...
    for (let year = 1; year <= totalYears; year++) {
      ...
      for (let i = 0; i < year; i++) {
        yearlyEquity += properties[i].reduce((sum, prop) => {
          const downPayment =
            prop.propertyPrice * (prop.downPaymentPercentage / 100);
    ...
    for (let year = 1; year <= totalYears; year++) {
      ...
      for (let i = 0; i < year; i++) {
        properties[i].forEach((property) => {
          ...
          totalInvestment +=
            property.propertyPrice * (property.downPaymentPercentage / 100);
        });
      }

      const cashOnCash =
        totalInvestment > 0 ? (totalCashFlow / totalInvestment) * 100 : 0;
    ...
    properties.forEach((yearProperties, yearIndex) => {
      yearProperties.forEach((property, propertyIndex) => {
        ...
        breakevenData.push({
          ...
          breakevenYear:
            breakevenYear <= totalYears ? breakevenYear : `>${totalYears}`,
          initialInvestment,
        });
      });
    });
    ...
    <div className="container mx-auto">
      ...
      <div className="mb-4">
        ...
        <Select
          ...
          defaultValue={totalYears.toString()}
        >
      ...
      <div className="mt-8 bg-white p-4 rounded-lg">
        <Tabs defaultValue="cumulative-profit" className="w-full ">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 gap-2 bg-white py-6 sm:py-0">
            <TabsTrigger className=" text-black" value="cumulative-profit">
              Cumulative Profit
            </TabsTrigger>
            <TabsTrigger className=" text-black" value="equity-build-up">
              Equity Build Up
            </TabsTrigger>
            <TabsTrigger className=" text-black" value="cash-on-cash">
              Cash On Cash
            </TabsTrigger>
            <TabsTrigger className=" text-black" value="breakeven-analysis">
              Breakeven analysis
            </TabsTrigger>
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  ...
                  <span> Assume 3% annual appreciation</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <CardHeader>
                ...
                <p>
                  <span className="text-sm text-gray-600">
                    Annual cash flow divided by the initial investment
                  </span>
                </p>
                <div className="pb-4">
                  <Dialog>
                    <DialogTrigger className="text-sm bg-gray-500 text-white rounded-md px-2 py-1">
                      Learn more
                    </DialogTrigger>
                    <DialogContent className="max-w-[800px] max-h-[80vh] overflow-y-auto bg-white text-black">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Cash-on-cash return (CoC return) is a metric that
                          measures the annual cash flow generated by an
                          investment as a percentage of the initial cash
                          investment. It provides a snapshot of how much income
                          an investor is receiving relative to the amount of
                          money they have invested. In practice, it shows how
                          efficiently an investment is generating income on the
                          actual cash that was used. It doesn't account for
                          things like appreciation, taxes, or loan payments—just
                          the direct cash flow versus the cash initially
                          invested. For example, if you invest $50,000 and the
                          investment generates $5,000 in annual cash flow, the
                          ...
                          <br />
                          <br />
                          This means you're earning 10% of your initial cash
                          investment back annually.
                        </DialogDescription>
                      </DialogHeader>
                    </DialogContent>
                  </Dialog>
